...
.factory('BackendService', ['$http', function ($http) {
  ...
  svc.getFeeds = function (data) {
      ...
      return $http.post('https://secure-waters-62757.herokuapp.com/api/manage/getAllConfessions', data, config)
  ...
  svc.postConfession = function (data) {
      ...
      return $http.post('https://secure-waters-62757.herokuapp.com/api/manage/Confession', data, config)
  ...
  svc.getProducts = function () {
      return $http.post('https://secure-waters-62757.herokuapp.com/api/manage/Confession');
  }
  return svc;
}])